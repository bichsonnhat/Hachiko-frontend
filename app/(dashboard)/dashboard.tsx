    ...
    return (
        <SafeAreaView className="flex-1 bg-white h-full">
            ...
            <View className="flex flex-row justify-between px-4 mb-4">
                ...
                <View className="flex-row items-center gap-3">
                    <TouchableOpacity onPress={() => router.push("/feedback")}>
                        <View
                            className="px-3 py-[10px] gap-2 mt-3 bg-[#FFA523] rounded-full flex-row items-center justify-center shadow-md shadow-slate-600">
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                {/* Tools List */}
                <View className="border mx-4 rounded-xl mb-4" style={{borderColor: '#f59e0b'}}>
                    {tools.map((tool, index) => (
                        ...
                        >
                            <View className="flex-row items-center">
                                ...
                                <Text className="ml-4 font-medium text-black">{tool.title}</Text>
                            </View>
